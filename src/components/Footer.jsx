...
function Footer() {
  return (
    <div className="w-full md:w-[80%] px-4 py-10 m-auto flex flex-col gap-y-7 lg:flex-row justify-between">
      <div className="w-full lg:w-[40%] flex flex-col gap-4">
        <div className="flex gap-4 items-center">
          ...
          <div className="font-semibold text-[1.2rem] text-[#1B1C57]">Leave It Local</div>
        </div>
        <div className="text-[#626687] text-[0.94rem] w-full lg:w-[70%] leading-6">
      ...
      <div className="w-full lg:w-[45%] flex gap-6 md:gap-14">
        <div className="space-y-[0.55rem] lg:ml-auto">
            <div className="text-[#0E1735] text-[1.08rem] font-semibold mb-2">Property</div>
            <div className="text-[#626687] text-[0.94rem]">House</div>
            <div className="text-[#626687] text-[0.94rem]">Apartment</div>
            <div className="text-[#626687] text-[0.94rem]">Villa</div>
        </div>
        <div className="space-y-[0.55rem]">
            <div className="text-[#0E1735] text-[1.08rem] font-semibold mb-2">Article</div>
            <div className="text-[#626687] text-[0.94rem]">New Article</div>
            <div className="text-[#626687] text-[0.94rem]">Popular Article</div>
        </div>
        <div className="space-y-[0.55rem]">
            <div className="text-[#0E1735] text-[1.08rem] font-semibold mb-2">Contact</div>
            <div className="text-[#626687] text-[0.94rem]">New Jersey 45463</div>
            <div className="text-[#626687] text-[0.94rem]">(671) 555-0110</div>
            <div className="text-[#626687] text-[0.94rem]">info@leaveitlocal.com</div>
        </div>
      </div>
    </div>
  );
